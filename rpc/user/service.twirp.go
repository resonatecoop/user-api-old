...
type UserService interface {
	...
	GetFavoriteTracks(context.Context, *User) (*FavoriteTracks, error)
...
func (c *userServiceProtobufClient) GetFavoriteTracks(ctx context.Context, in *User) (*FavoriteTracks, error) {
	ctx = ctxsetters.WithPackageName(ctx, "resonate.api.user")
	ctx = ctxsetters.WithServiceName(ctx, "UserService")
	ctx = ctxsetters.WithMethodName(ctx, "GetFavoriteTracks")
	out := new(FavoriteTracks)
...
func (c *userServiceJSONClient) GetFavoriteTracks(ctx context.Context, in *User) (*FavoriteTracks, error) {
	ctx = ctxsetters.WithPackageName(ctx, "resonate.api.user")
	ctx = ctxsetters.WithServiceName(ctx, "UserService")
	ctx = ctxsetters.WithMethodName(ctx, "GetFavoriteTracks")
	out := new(FavoriteTracks)
...
func (s *userServiceServer) serveGetFavoriteTracksJSON(ctx context.Context, resp http.ResponseWriter, req *http.Request) {
	...
	// Call service method
	var respContent *FavoriteTracks
	func() {
		defer func() {
			// In case of a panic, serve a 500 error and then panic.
			if r := recover(); r != nil {
	...
	if respContent == nil {
		s.writeError(ctx, resp, twirp.InternalError("received a nil *FavoriteTracks and nil error while calling GetFavoriteTracks. nil responses are not supported"))
		return
	}
...
var twirpFileDescriptor0 = []byte{
	...
	,
}
