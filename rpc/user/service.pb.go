...
func (*User) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b37c89eef03e0bee, []int{0}
}
...
func (*Playlists) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b37c89eef03e0bee, []int{1}
}
...
func (*Tracks) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b37c89eef03e0bee, []int{2}
}
...
func (*StreetAddress) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b37c89eef03e0bee, []int{3}
}
...
func (*Artists) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b37c89eef03e0bee, []int{4}
}
...
func (*UserToUserGroup) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b37c89eef03e0bee, []int{5}
}
...
func (*UserToTrack) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b37c89eef03e0bee, []int{6}
}
...
func (*Play) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b37c89eef03e0bee, []int{7}
}
...
func (*CreatePlayRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b37c89eef03e0bee, []int{8}
}
...
func (*CreatePlayResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_service_b37c89eef03e0bee, []int{9}
}
...
func init() { proto.RegisterFile("rpc/user/service.proto", fileDescriptor_service_b37c89eef03e0bee) }

var fileDescriptor_service_b37c89eef03e0bee = []byte{
