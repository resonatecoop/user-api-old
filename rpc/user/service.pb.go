...
type User struct {
	...
	OwnerOfGroups          []*resonate_api_user.RelatedUserGroup `protobuf:"bytes,13,rep,name=owner_of_groups,json=ownerOfGroups" json:"owner_of_groups,omitempty"`
...
func (m *User) GetOwnerOfGroups() []*resonate_api_user.RelatedUserGroup {
	if m != nil {
...
type Playlists struct {
	Playlists []*resonate_api_user.RelatedTrackGroup `protobuf:"bytes,1,rep,name=playlists" json:"playlists,omitempty"`
}
...
func (*Playlists) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }

func (m *Playlists) GetPlaylists() []*resonate_api_user.RelatedTrackGroup {
	if m != nil {
		return m.Playlists
	}
	return nil
...
type Tracks struct {
	Tracks []*resonate_api_user1.Track `protobuf:"bytes,1,rep,name=tracks" json:"tracks,omitempty"`
}

func (m *Tracks) Reset()                    { *m = Tracks{} }
func (m *Tracks) String() string            { return proto.CompactTextString(m) }
func (*Tracks) ProtoMessage()               {}
func (*Tracks) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }

func (m *Tracks) GetTracks() []*resonate_api_user1.Track {
	if m != nil {
		return m.Tracks
	}
	return nil
...
func (*StreetAddress) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{3} }
...
type Artists struct {
	Artists []*resonate_api_user.RelatedUserGroup `protobuf:"bytes,1,rep,name=artists" json:"artists,omitempty"`
}

func (m *Artists) Reset()                    { *m = Artists{} }
func (m *Artists) String() string            { return proto.CompactTextString(m) }
func (*Artists) ProtoMessage()               {}
func (*Artists) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{4} }

func (m *Artists) GetArtists() []*resonate_api_user.RelatedUserGroup {
	if m != nil {
		return m.Artists
	}
	return nil
...
func (*UserToUserGroup) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{5} }
...
func (*UserToTrack) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{6} }
...
func (*Play) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{7} }
...
func (*CreatePlayRequest) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{8} }
...
func (*CreatePlayResponse) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{9} }
