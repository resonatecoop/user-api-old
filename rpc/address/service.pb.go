...
func (*AddressQuery) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{0} }
...
func (*AddressResults) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{1} }
...
type AddressResult struct {
	...
	LocaleNames    map[string]*google_protobuf.ListValue `protobuf:"bytes,7,rep,name=locale_names,json=localeNames" json:"locale_names,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
	City           map[string]*google_protobuf.ListValue `protobuf:"bytes,8,rep,name=city" json:"city,omitempty" protobuf_key:"bytes,1,opt,name=key" protobuf_val:"bytes,2,opt,name=value"`
}
...
func (*AddressResult) Descriptor() ([]byte, []int) { return fileDescriptor0, []int{2} }
...
func (m *AddressResult) GetLocaleNames() map[string]*google_protobuf.ListValue {
	if m != nil {
...
func (m *AddressResult) GetCity() map[string]*google_protobuf.ListValue {
	if m != nil {
		return m.City
	}
	return nil
...
func init() { proto.RegisterFile("rpc/address/service.proto", fileDescriptor0) }
